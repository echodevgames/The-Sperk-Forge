...
| FW-DOC-04 | `EchoSceneFlow` | The Passage — Scene Flow | Defines normal transition authority after First Light handoff, loading phases, progress, locking, and failure behavior | Next |
...
| In drafting | 0 |
| Remaining | 7 |
| Current checkpoint | FW-DOC-04 — EchoSceneFlow |
