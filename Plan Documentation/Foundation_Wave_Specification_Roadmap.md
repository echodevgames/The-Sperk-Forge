...
| FW-DOC-05 | `EchoGameState` | The Pulse — Runtime State | Defines high-level modes, pause authority, time/cursor/input coordination requests, and nested state reasons | Next |
...
| In drafting | 0 |
| Remaining | 6 |
| Current checkpoint | FW-DOC-05 — EchoGameState |
